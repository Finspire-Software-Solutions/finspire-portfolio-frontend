   ...
   private works: Work[] = [
    {
      ...
      excerpt: 'A fully responsive e-commerce solution with advanced features',
    ...
    },
    {
      ...
      excerpt: 'Complete brand and digital identity for Ceylon Choice, a food manufacturing and import company serving the UK and France markets.',
    ...
    },
    {
      ...
      excerpt: 'Complete brand identity package for tech startup',
